...
function StatCard({
  ...
  return (
    <div className="flex-1 min-w-[220px] rounded-xl border border-[#E5E5E5] bg-white p-6 hover:shadow-lg transition-shadow">
      <div className="flex items-start justify-between mb-6">
        <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#5C6ED5] to-[#3E5A99] flex items-center justify-center shrink-0">
          {icon}
        </div>
        <span className="text-[#737373] text-xs font-normal leading-4 tracking-[-0.2px]">Total</span>
      </div>
      <p className="text-[#171717] text-3xl font-normal leading-9 tracking-[-0.5px] mb-1">{value}</p>
      <p className="text-[#525252] text-sm font-normal leading-5 tracking-[-0.5px]">{label}</p>
    </div>
  );
}
...
function QuickAccessCard({
  ...
  return (
    <div className="flex-1 min-w-[280px] rounded-xl border border-[#E5E5E5] bg-white overflow-hidden flex flex-col hover:shadow-lg transition-shadow">
      <div className="p-6 flex flex-col gap-4 flex-1">
        <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#5C6ED5] to-[#3E5A99] flex items-center justify-center shrink-0">
          {icon}
        </div>
        <div className="flex flex-col gap-2">
          <h4 className="text-[#171717] text-xl font-normal leading-7 tracking-[-0.5px]">{title}</h4>
          <p className="text-[#525252] text-sm font-normal leading-5 tracking-[-0.5px]">{description}</p>
        </div>
        <Link
          href={href}
          className="mt-2 flex items-center justify-center gap-2 rounded-lg bg-[#5C6ED5] text-white text-base font-normal leading-5 tracking-[-0.5px] py-3 px-4 hover:bg-[#3E5A99] transition-colors"
        >
          {buttonLabel}
      ...
      <div className="border-t border-[#E5E5E5] bg-[#FAFAFA] px-6 py-4 flex items-center justify-between">
        <span className="text-[#525252] text-sm font-normal leading-5 tracking-[-0.5px]">Last updated</span>
        <span className="text-[#171717] text-sm font-normal leading-5 tracking-[-0.5px]">{lastUpdated}</span>
      </div>
    </div>
  );
}
...
function ActivityItem({
  ...
  return (
    <div className={`flex items-center gap-4 px-4 py-4 sm:px-6 hover:bg-[#F5F5F5] transition-colors ${!isFirst ? "border-t border-[#E5E5E5]" : ""}`}>
      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#5C6ED5]/10 to-[#3E5A99]/10 flex items-center justify-center shrink-0">
        {icon}
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-[#171717] text-sm font-normal leading-5 tracking-[-0.5px]">{title}</p>
        <p className="text-[#737373] text-xs font-normal leading-4 tracking-[-0.5px]">{subtitle}</p>
      </div>
      <span className="text-[#737373] text-xs font-normal leading-4 tracking-[-0.5px] shrink-0">{time}</span>
    </div>
  );
}
...
export default function Index() {
  return (
    <div className="min-h-screen flex flex-col bg-[#FAFAFA]">
      ...
      <main className="flex-1 w-full max-w-[2000px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 py-10 flex flex-col gap-10">
        {/* Welcome section */}
        <section className="rounded-xl border border-[#E5E5E5] bg-white p-8 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-[#171717] text-3xl font-normal leading-9 tracking-[-0.664px]">Welcome Admin!</h1>
          </div>
          <p className="text-[#525252] text-base font-normal leading-6 tracking-[-0.5px]">
        ...
        <section className="flex flex-col gap-6">
          <h3 className="text-[#171717] text-xl font-normal leading-7 tracking-[-0.5px]">Quick Access</h3>
        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="rounded-xl border border-[#E5E5E5] bg-white overflow-hidden">
            ...
            <ActivityItem
              ...
              subtitle="50 new items added to stock"
              time="1 hour ago"
              icon={
                <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.58438 1.82812L0 5H6.5V1H2.92812C2.35938 1 1.84063 1.32187 1.58438 1.82812ZM7.5 5H14L12.4156 1.82812C12.1594 1.32187 11.6406 1 11.0719 1H7.5V5ZM14 6H0V13C0 14.1031 0.896875 15 2 15H12C13.1031 15 14 14.1031 14 13V6Z" fill="#5C6ED5"/>
                </svg>
              }
            />
            <ActivityItem
              isFirst={false}
              title="Volunteer shift scheduled"
              subtitle="8 volunteers assigned for tomorrow"
              time="3 hours ago"
              icon={
                <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clipPath="url(#clip0_act3)">
                    <path d="M4 0C4.55312 0 5 0.446875 5 1V2H9V1C9 0.446875 9.44687 0 10 0C10.5531 0 11 0.446875 11 1V2H12.5C13.3281 2 14 2.67188 14 3.5V5H0V3.5C0 2.67188 0.671875 2 1.5 2H3V1C3 0.446875 3.44688 0 4 0ZM0 6H14V14.5C14 15.3281 13.3281 16 12.5 16H1.5C0.671875 16 0 15.3281 0 14.5V6ZM10.2812 9.53125C10.575 9.2375 10.575 8.7625 10.2812 8.47188C9.9875 8.18125 9.5125 8.17813 9.22188 8.47188L6.25313 11.4406L4.78438 9.97188C4.49063 9.67813 4.01562 9.67813 3.725 9.97188C3.43437 10.2656 3.43125 10.7406 3.725 11.0312L5.725 13.0312C6.01875 13.325 6.49375 13.325 6.78438 13.0312L10.2812 9.53125Z" fill="#5C6ED5"/>
                  </g>
                  <defs>
                    <clipPath id="clip0_act3">
